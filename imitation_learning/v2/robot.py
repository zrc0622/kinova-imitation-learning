...
class Robot(object):
  ...
  def get_cartesian_pose(self):  # jixiebie pose
    arm_group = self.arm_group
  ...
  def get_gripper_position(self): # jiazhua pose
    gripper_group = self.gripper_group
  ...
  def init_scene(self,peg_pose=[0.,0.,0.],hole_pose=[0.,0.,0.]):
    ...
    peg_sdf_path='/home/prlab/catkin_workspace/src/mesh/peg/model.sdf'
    ...
    hole_sdf_path='/home/prlab/catkin_workspace/src/mesh/hole/model.sdf'
