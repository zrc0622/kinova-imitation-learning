...
class gen3env(gym.Env):
    ...
    def __init__(self):
        ...
        self.hole_pose=[1,-0.4,0.3] #[1.,-0.2,0.3] 
        self.info=None
        self.fail_num=0
        self.step_num=0
        action_low=[-1.,-1.,-1.,-1.]
    ...
    def do_sim(self,action):
        ...
        success=self.robot.move(pose=action[:-1])
    ...
    def step(self,action):
        ...
        done=bool(peg_hole_dis<0.005) or bool(peg_hole_dis>1.)
        
        self.step_num+=1
        # _,obs=self.scale(obs=obs)
        # print('='*50)
        # print('after scale',obs)
        truncated=bool(peg_hole_dis>1.) or bool(self.fail_num>=3)
        info={
            "step":self.step_num,
            "reward":reward,
            "reach_rew":reach_rew,
